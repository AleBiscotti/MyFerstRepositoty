#############################################################################
# Makefile for building: ThreadSafeContainer
# Generated by qmake (3.1) (Qt 5.15.16)
# Project:  ../../ThreadSafeContainer.pro
# Template: app
# Command: /usr/bin/qmake -o Makefile ../../ThreadSafeContainer.pro -spec linux-clang CONFIG+=debug CONFIG+=qml_debug
#############################################################################
...
INCPATH       = -I../../../ThreadSafeContainer -I. -I/usr/include/qt -I/usr/include/qt/QtCore -I. -I/usr/lib/qt/mkspecs/linux-clang
QMAKE         = /usr/bin/qmake
DEL_FILE      = rm -f
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = ThreadSafeContainer1.0.0
DISTDIR = /home/eleonora/Projects/ThreadSafeContainer/build/Desktop-Debug/.tmp/ThreadSafeContainer1.0.0
LINK          = clang++
LFLAGS        = -ccc-gcc-name g++ -fPIC
...
DIST          = /usr/lib/qt/mkspecs/features/spec_pre.prf \
		...
		/usr/lib/qt/mkspecs/features/cmdline.prf \
		...
		../../../../ThreadSafeContainer.pro  ../../main.cpp
QMAKE_TARGET  = ThreadSafeContainer
DESTDIR       = 
TARGET        = ThreadSafeContainer


first: all
####### Build rules

ThreadSafeContainer:  $(OBJECTS)  
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: ../../ThreadSafeContainer.pro /usr/lib/qt/mkspecs/linux-clang/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/sanitize.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
		...
		/usr/lib/qt/mkspecs/features/yacc.prf \
		/usr/lib/qt/mkspecs/features/lex.prf \
		../../ThreadSafeContainer.pro
	$(QMAKE) -o Makefile ../../ThreadSafeContainer.pro -spec linux-clang CONFIG+=debug CONFIG+=qml_debug
...
all: Makefile ThreadSafeContainer
...
install_target: first FORCE
	@test -d $(INSTALL_ROOT)/opt/ThreadSafeContainer/bin || mkdir -p $(INSTALL_ROOT)/opt/ThreadSafeContainer/bin
	$(QINSTALL_PROGRAM) $(QMAKE_TARGET) $(INSTALL_ROOT)/opt/ThreadSafeContainer/bin/$(QMAKE_TARGET)

uninstall_target: FORCE
	-$(DEL_FILE) $(INSTALL_ROOT)/opt/ThreadSafeContainer/bin/$(QMAKE_TARGET)
	-$(DEL_DIR) $(INSTALL_ROOT)/opt/ThreadSafeContainer/bin/ 
